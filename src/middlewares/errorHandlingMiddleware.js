...
export const errorHandlingMiddleware = (err, req, res, next) => {
  ...
  const responseError = {
    ...
    message: err.message || StatusCodes[err.statusCode], // Nếu lỗi mà không có message thì lấy ReasonPhrases chuẩn theo mã Status Code (vd: INTERNAL_SERVER_ERROR,...)
    stack: err.stack // để show đc những file bị lỗi, vị trí, dòng, ở log
  }
